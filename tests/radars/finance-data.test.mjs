...
const researchRoot = fileURLToPath(new URL('../../work/radars/2026-08-24/finance/', import.meta.url));

test('finance closes its source ledger and publishes a corporate-finance library', async () => {
  ...
  const radar = await loadRadarFile(`${radarRoot}/data/finance.js`);
