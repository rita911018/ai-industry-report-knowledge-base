(() => {
  ...
  hrRadar.scenarios.push(
    ...
    },
    {
      ...
      evidenceIds: ['hr-src-11', 'hr-case-13'], companyCases: [{ company: '贵州茅台', summary: '金蝶案例描述茅台对员工、社保和年金等人力资源业务进行一体化管理。', sourceId: 'hr-case-13', caseType: '客户案例', caveat: '这是业务整合案例，未证明 AI 可自动完成官方申报。', market: '中国' }],
      confidence: { level: 'low', reason: 'WorkBuddy 文章提供流程示例；供应商资料和客户案例只能支持方向判断，效果需在本企业重新验证。' },
      humanHandoff: '低置信度、规则冲突、个人权益或任何不可逆动作必须转交具名 HR；工资、申报和法律文件不得由 AI 独立生效。', evidenceWindow: 'current',
      sourceFacts: [{ sourceId: 'hr-src-11', text: 'WorkBuddy 文章将花名册维护、材料缺失和社保状态检查作为日常人事流程示例，未验证自动申报。', locator: '第二个工作流：人员全生命周期管理；第四个工作流：社保公积金业务操作' }, { sourceId: 'hr-case-13', text: '茅台案例描述人员、社保和年金等 HR 业务的数字化整合。', locator: '一体共享，让数据多跑腿' }],
    ...
    },
    {
      ...
      evidenceIds: ['hr-src-11', 'hr-case-12'], companyCases: [{ company: 'Bayer', summary: 'ServiceNow 案例称 Bayer 用 Now Assist 自动摘要 HR 工单和对话，供 HR 坐席处理。', sourceId: 'hr-case-12', caseType: '客户案例', caveat: '案例仅支持 HR 案例摘要，不支持劳动法文书起草。', market: '国际' }],
      confidence: { level: 'low', reason: 'WorkBuddy 文章提供流程示例；供应商资料和客户案例只能支持方向判断，效果需在本企业重新验证。' },
      humanHandoff: '低置信度、规则冲突、个人权益或任何不可逆动作必须转交具名 HR；工资、申报和法律文件不得由 AI 独立生效。', evidenceWindow: 'current',
      sourceFacts: [{ sourceId: 'hr-case-12', text: 'ServiceNow 披露 Bayer 用 Now Assist 自动摘要 HR 案例和聊天，每周生成 350 多份摘要。', locator: 'Bayer solves HR case backlog with GenAI' }, { sourceId: 'hr-src-11', text: 'WorkBuddy 文章以个人实务方式演示日常人事工作流程，未提供独立效果评估。', locator: '第五个工作流：员工关系处理' }],
    ...
    },
    {
      ...
      evidenceIds: ['hr-src-11', 'hr-case-12'], companyCases: [{ company: 'Bayer', summary: 'ServiceNow 客户案例披露 Bayer 用生成式 AI 摘要 HR 工单和对话，供 HR 坐席处理。', sourceId: 'hr-case-12', caseType: '客户案例', caveat: '这是邻近的案例摘要证据，不是仲裁证据分析。', market: '国际' }],
      confidence: { level: 'low', reason: 'WorkBuddy 文章提供流程示例；供应商资料和客户案例只能支持方向判断，效果需在本企业重新验证。' },
      humanHandoff: '低置信度、规则冲突、个人权益或任何不可逆动作必须转交具名 HR；工资、申报和法律文件不得由 AI 独立生效。', evidenceWindow: 'current',
      sourceFacts: [{ sourceId: 'hr-case-12', text: 'Bayer 案例中 Now Assist 的公开用途是摘要 HR 案例和聊天，帮助 HR 坐席获取信息。', locator: 'Bayer solves HR case backlog with GenAI' }, { sourceId: 'hr-src-11', text: 'WorkBuddy 文章以个人实务方式演示日常人事工作流程，未提供仲裁材料分析成效。', locator: '第五个工作流：员工关系处理' }],
